...
# for each of the following labels describe the location, structure, shape and other visual attributes that would be apparent in an X ray image. output in json format where the key are the labels and values are the descriptions.
