...
def train_cocoop():
    ...
    model_weights_path = f'weights{os.sep}task_2_3_st1_best_cocoop_model.pth'
    ...
    for epoch in range(1):
        ...
        if avg_loss < best_loss:
            best_loss = avg_loss
            patience_counter = 0
            torch.save(cocoop_clip.state_dict(), f'{weights_folder}{os.sep}task_2_3_st1_best_cocoop_model.pth')
            
            # Save training history
            history_path = f'{results_folder}{os.sep}task_2_3_st1_cocoop_training_history_{datetime.now().strftime("%Y%m%dT%H%M%S")}.json'
...
if __name__ == "__main__":
    ...
    model_weights_path = f'{weights_folder}{os.sep}task_2_3_st1_best_cocoop_model.pth'
    ...
    if os.path.exists(model_weights_path):
        ...
        results_path = f"{results_folder}{os.sep}task-2_3_st1_cocoop_results.json"
